...
//        }
//
//        if (StaticClasses.duelManager.getArenas().size() <= 0) {
...
//            for (int i = 0; i < StaticClasses.duelManager.getArenas().size(); i++) {
//                if (i < StaticClasses.duelManager.getArenas().size() - 1) {
//                    Arena arena = StaticClasses.duelManager.getArenas().get(i);
//
